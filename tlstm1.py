...
class TLSTM1Layer(MergeLayer):
    ...
    def __init__(self, incoming,time_input, num_units,
        ...
        super(TLSTM1Layer, self).__init__(incomings, **kwargs)
    ...
    def get_output_for(self, inputs, **kwargs):
        ...
        W_in_stacked = T.concatenate(
            [self.W_in_to_ingate, self.W_in_to_forgetgate,
             self.W_in_to_cell, self.W_in_to_outgate, self.W_x1_to_tg1], axis=1)
        ...
        b_stacked = T.concatenate(
            [self.b_ingate, self.b_forgetgate,
             self.b_cell, self.b_outgate, self.b1_tg1], axis=0)
        ...
        # todo
        # insert Tm, weight_t_o in to mask_n and xell_previous
